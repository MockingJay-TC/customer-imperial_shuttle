...
const Search = () => {
  return (
    <div className="hidden p-16 gap-8 absolute left-2/4 -translate-x-2/4 w-2/3 h-10 md:h-40 -mt-5 md:-mt-20 z-50 bg-white shadow-lg rounded-full md:flex items-center justify-evenly">
